...
class SScholl_SolrCatalogAnnotationImport_Helper_Config
{
	...
	private function _getImportFolder($file = '')
	{
		...
		return Mage::getStoreConfig('sschollsolrcatalogannotationimport/folder/import') . $file;
	}

	private function _getImportedFolder($file = '')
	{
		if ( $file ) $file = DS . $file;
		return  Mage::getStoreConfig('sschollsolrcatalogannotationimport/folder/imported') . $file;
	}
